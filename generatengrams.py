'''
Module to compute scores of various intent on the .
'''
...
def ngrams(lines):
    '''
    generates a dictionary containing counts of the contiguous sequences
    of n-items in the input lines(here n == limit)
    '''
    global limit
    ngrams = []
...
def score(uinput:str, tngramsdict:dict):
    '''
    Computes the score of the each intent w.r.t to the uinput.
    '''
    global limit
    scores = []
